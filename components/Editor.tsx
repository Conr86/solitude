...
export default function EditorComponent({ id, title, createdAt, updatedAt, content }: any) {
    ...
    useEffect(() => { setCurrentTitle(title), setLastSaved(updatedAt), setUnsavedChanges(false) }, [id]);
        ...
        <div className="px-4 md:px-6 leading-normal">
            ...
            <div className="flex gap-2 flex-row">
                ...
                <div className="flex gap-2 h-10 -mt-4 grow flex-row place-content-end">
                    <svg className={`py-3 px-2 ${!unsavedChanges ? "fill-green-600" : "fill-amber-500 animate-pulse"}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"/></svg>
