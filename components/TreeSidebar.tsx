                        ...
                        <div className="flex items-center mb-2">
                            ...
                            <div className="relative w-full">
                                ...
                                <input type="text" id="simple-search" value={filterText} onChange={e => { setFilterText(e.target.value) }}
                                    className="bg-gray-50 outline-none focus:border-primary-700 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Search" />
