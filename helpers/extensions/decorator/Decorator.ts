...
function runAllDecoratorPlugins(doc: ProsemirrorNode, plugins: Array<typeof DecoratorPlugin>) {
      ...
      new Plugin({
        ...
        state: {
          ...
          apply(transaction, oldState) {
            return transaction.docChanged ? runAllDecoratorPlugins(transaction.doc, plugins) : oldState
          },
        },
        props: {
          decorations(state) {
